...
public class ToolbarGroup {
  ...
  public static final String CSS_ENABLED= "common-toolbar-group-label";  //$NON-NLS-1$ 
  public static final String CSS_DISABLED = "common-toolbar-group-label-disabled";  //$NON-NLS-1$ 

...
public class NumericFilterPositiveFloat implements KeyboardListener{
  private static NumericFilterPositiveFloat instance = null;
  
  private NumericFilterPositiveFloat(){
    super();
  }
  
  public static synchronized NumericFilterPositiveFloat getInstance(){
    if(instance == null){
      instance = new NumericFilterPositiveFloat();
    }
    return instance;
  }
